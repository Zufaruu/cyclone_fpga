...
////////////////////////////////////////////////////////////////
//Module Architecture: Lowpass_1_MHz_V2
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter signed [13:0] coeff1 = 14'b00000001010011; //sfix14_En17
  parameter signed [13:0] coeff2 = 14'b00000000100110; //sfix14_En17
  parameter signed [13:0] coeff3 = 14'b00000000101100; //sfix14_En17
  parameter signed [13:0] coeff4 = 14'b00000000101111; //sfix14_En17
  parameter signed [13:0] coeff5 = 14'b00000000101111; //sfix14_En17
  parameter signed [13:0] coeff6 = 14'b00000000101011; //sfix14_En17
  parameter signed [13:0] coeff7 = 14'b00000000100001; //sfix14_En17
  parameter signed [13:0] coeff8 = 14'b00000000010000; //sfix14_En17
  parameter signed [13:0] coeff9 = 14'b11111111111000; //sfix14_En17
  parameter signed [13:0] coeff10 = 14'b11111111010111; //sfix14_En17
  parameter signed [13:0] coeff11 = 14'b11111110101101; //sfix14_En17
  parameter signed [13:0] coeff12 = 14'b11111101111010; //sfix14_En17
  parameter signed [13:0] coeff13 = 14'b11111100111101; //sfix14_En17
  parameter signed [13:0] coeff14 = 14'b11111011110111; //sfix14_En17
  parameter signed [13:0] coeff15 = 14'b11111010101001; //sfix14_En17
  parameter signed [13:0] coeff16 = 14'b11111001010100; //sfix14_En17
  parameter signed [13:0] coeff17 = 14'b11110111111010; //sfix14_En17
  parameter signed [13:0] coeff18 = 14'b11110110011101; //sfix14_En17
  parameter signed [13:0] coeff19 = 14'b11110101000001; //sfix14_En17
  parameter signed [13:0] coeff20 = 14'b11110011101000; //sfix14_En17
  parameter signed [13:0] coeff21 = 14'b11110010011000; //sfix14_En17
  parameter signed [13:0] coeff22 = 14'b11110001010011; //sfix14_En17
  parameter signed [13:0] coeff23 = 14'b11110000100000; //sfix14_En17
  parameter signed [13:0] coeff24 = 14'b11110000000001; //sfix14_En17
  parameter signed [13:0] coeff25 = 14'b11101111111100; //sfix14_En17
  parameter signed [13:0] coeff26 = 14'b11110000010101; //sfix14_En17
  parameter signed [13:0] coeff27 = 14'b11110001010001; //sfix14_En17
  parameter signed [13:0] coeff28 = 14'b11110010110011; //sfix14_En17
  parameter signed [13:0] coeff29 = 14'b11110100111101; //sfix14_En17
  parameter signed [13:0] coeff30 = 14'b11110111110011; //sfix14_En17
  parameter signed [13:0] coeff31 = 14'b11111011010110; //sfix14_En17
  parameter signed [13:0] coeff32 = 14'b11111111100110; //sfix14_En17
  parameter signed [13:0] coeff33 = 14'b00000100100001; //sfix14_En17
  parameter signed [13:0] coeff34 = 14'b00001010000111; //sfix14_En17
  parameter signed [13:0] coeff35 = 14'b00010000010100; //sfix14_En17
  parameter signed [13:0] coeff36 = 14'b00010111000011; //sfix14_En17
  parameter signed [13:0] coeff37 = 14'b00011110001111; //sfix14_En17
  parameter signed [13:0] coeff38 = 14'b00100101110010; //sfix14_En17
  parameter signed [13:0] coeff39 = 14'b00101101100100; //sfix14_En17
  parameter signed [13:0] coeff40 = 14'b00110101011101; //sfix14_En17
  parameter signed [13:0] coeff41 = 14'b00111101010011; //sfix14_En17
  parameter signed [13:0] coeff42 = 14'b01000100111111; //sfix14_En17
  parameter signed [13:0] coeff43 = 14'b01001100010110; //sfix14_En17
  parameter signed [13:0] coeff44 = 14'b01010011010000; //sfix14_En17
  parameter signed [13:0] coeff45 = 14'b01011001100011; //sfix14_En17
  parameter signed [13:0] coeff46 = 14'b01011111000111; //sfix14_En17
  parameter signed [13:0] coeff47 = 14'b01100011110110; //sfix14_En17
  parameter signed [13:0] coeff48 = 14'b01100111101000; //sfix14_En17
  parameter signed [13:0] coeff49 = 14'b01101010011001; //sfix14_En17
  parameter signed [13:0] coeff50 = 14'b01101100000101; //sfix14_En17
  parameter signed [13:0] coeff51 = 14'b01101100101001; //sfix14_En17
  parameter signed [13:0] coeff52 = 14'b01101100000101; //sfix14_En17
  parameter signed [13:0] coeff53 = 14'b01101010011001; //sfix14_En17
  parameter signed [13:0] coeff54 = 14'b01100111101000; //sfix14_En17
  parameter signed [13:0] coeff55 = 14'b01100011110110; //sfix14_En17
  parameter signed [13:0] coeff56 = 14'b01011111000111; //sfix14_En17
  parameter signed [13:0] coeff57 = 14'b01011001100011; //sfix14_En17
  parameter signed [13:0] coeff58 = 14'b01010011010000; //sfix14_En17
  parameter signed [13:0] coeff59 = 14'b01001100010110; //sfix14_En17
  parameter signed [13:0] coeff60 = 14'b01000100111111; //sfix14_En17
  parameter signed [13:0] coeff61 = 14'b00111101010011; //sfix14_En17
  parameter signed [13:0] coeff62 = 14'b00110101011101; //sfix14_En17
  parameter signed [13:0] coeff63 = 14'b00101101100100; //sfix14_En17
  parameter signed [13:0] coeff64 = 14'b00100101110010; //sfix14_En17
  parameter signed [13:0] coeff65 = 14'b00011110001111; //sfix14_En17
  parameter signed [13:0] coeff66 = 14'b00010111000011; //sfix14_En17
  parameter signed [13:0] coeff67 = 14'b00010000010100; //sfix14_En17
  parameter signed [13:0] coeff68 = 14'b00001010000111; //sfix14_En17
  parameter signed [13:0] coeff69 = 14'b00000100100001; //sfix14_En17
  parameter signed [13:0] coeff70 = 14'b11111111100110; //sfix14_En17
  parameter signed [13:0] coeff71 = 14'b11111011010110; //sfix14_En17
  parameter signed [13:0] coeff72 = 14'b11110111110011; //sfix14_En17
  parameter signed [13:0] coeff73 = 14'b11110100111101; //sfix14_En17
  parameter signed [13:0] coeff74 = 14'b11110010110011; //sfix14_En17
  parameter signed [13:0] coeff75 = 14'b11110001010001; //sfix14_En17
  parameter signed [13:0] coeff76 = 14'b11110000010101; //sfix14_En17
  parameter signed [13:0] coeff77 = 14'b11101111111100; //sfix14_En17
  parameter signed [13:0] coeff78 = 14'b11110000000001; //sfix14_En17
  parameter signed [13:0] coeff79 = 14'b11110000100000; //sfix14_En17
  parameter signed [13:0] coeff80 = 14'b11110001010011; //sfix14_En17
  parameter signed [13:0] coeff81 = 14'b11110010011000; //sfix14_En17
  parameter signed [13:0] coeff82 = 14'b11110011101000; //sfix14_En17
  parameter signed [13:0] coeff83 = 14'b11110101000001; //sfix14_En17
  parameter signed [13:0] coeff84 = 14'b11110110011101; //sfix14_En17
  parameter signed [13:0] coeff85 = 14'b11110111111010; //sfix14_En17
  parameter signed [13:0] coeff86 = 14'b11111001010100; //sfix14_En17
  parameter signed [13:0] coeff87 = 14'b11111010101001; //sfix14_En17
  parameter signed [13:0] coeff88 = 14'b11111011110111; //sfix14_En17
  parameter signed [13:0] coeff89 = 14'b11111100111101; //sfix14_En17
  parameter signed [13:0] coeff90 = 14'b11111101111010; //sfix14_En17
  parameter signed [13:0] coeff91 = 14'b11111110101101; //sfix14_En17
  parameter signed [13:0] coeff92 = 14'b11111111010111; //sfix14_En17
  parameter signed [13:0] coeff93 = 14'b11111111111000; //sfix14_En17
  parameter signed [13:0] coeff94 = 14'b00000000010000; //sfix14_En17
  parameter signed [13:0] coeff95 = 14'b00000000100001; //sfix14_En17
  parameter signed [13:0] coeff96 = 14'b00000000101011; //sfix14_En17
  parameter signed [13:0] coeff97 = 14'b00000000101111; //sfix14_En17
  parameter signed [13:0] coeff98 = 14'b00000000101111; //sfix14_En17
  parameter signed [13:0] coeff99 = 14'b00000000101100; //sfix14_En17
  parameter signed [13:0] coeff100 = 14'b00000000100110; //sfix14_En17
  parameter signed [13:0] coeff101 = 14'b00000001010011; //sfix14_En17
  ...
  assign product94 = $signed({delay_pipeline[93][13:0], 4'b0000});

  assign mulpwr2_temp = (delay_pipeline[92]==14'b10000000000000) ? $signed({1'b0, delay_pipeline[92]}) : -delay_pipeline[92];

  assign product93 = $signed({mulpwr2_temp[14:0], 3'b000});
  ...
  assign mulpwr2_temp_1 = (delay_pipeline[8]==14'b10000000000000) ? $signed({1'b0, delay_pipeline[8]}) : -delay_pipeline[8];

  assign product9 = $signed({mulpwr2_temp_1[14:0], 3'b000});

  assign product8 = $signed({delay_pipeline[7][13:0], 4'b0000});

  assign mul_temp_90 = delay_pipeline[6] * coeff7;
  assign product7 = mul_temp_90[26:0];

  assign mul_temp_91 = delay_pipeline[5] * coeff6;
  assign product6 = mul_temp_91[26:0];

  assign mul_temp_92 = delay_pipeline[4] * coeff5;
  assign product5 = mul_temp_92[26:0];

  assign mul_temp_93 = delay_pipeline[3] * coeff4;
  assign product4 = mul_temp_93[26:0];

  assign mul_temp_94 = delay_pipeline[2] * coeff3;
  assign product3 = mul_temp_94[26:0];

  assign mul_temp_95 = delay_pipeline[1] * coeff2;
  assign product2 = mul_temp_95[26:0];
